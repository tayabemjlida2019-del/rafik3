...
// Feature label mapping for hotels
            ...
            <div className="lg:w-80 shrink-0">
                <div className="bg-white rounded-[32px] border border-gray-100 p-8 sticky top-28 shadow-sm">
                    ...
                    <div className="space-y-4">
                        ...
                        {/* Price Range */}
                        <div>
                            <label className="block text-sm font-medium text-gray-700 mb-1">السعر (دج/ليلة)</label>
                ...
                {loading ? (
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
                        {listings.map((listing) => (
                            ...
                            >
                                <div className="relative h-48 bg-gradient-to-br from-purple-50 to-blue-100 flex items-center justify-center">
                                    {listing.images?.[0] ? (
                                        <img
                                    ...
                                    {listing.provider?.kycStatus === 'VERIFIED' && (
                                        <div className="absolute top-3 right-3">
                                            <span className="badge-success text-xs">✅ موثق</span>
                                        </div>
                                    )}
                                    <div className="absolute bottom-3 left-3">
                                        <span className="badge bg-white/90 backdrop-blur-sm text-gray-700 text-xs">
                                ...
                                <div className="p-4">
                                    <div className="flex items-center gap-1 text-gray-500 text-sm mb-1">
                                        ...
                                        {listing.provider && (
                                            <>
                                                ...
                                                <span>{listing.provider.businessName}</span>
                                            </>
                                        )}
                                    </div>
                                    ...
                                    {listing.metadata?.amenities && (
                                        <div className="flex flex-wrap gap-1 mt-3">
                                            {listing.metadata.amenities.slice(0, 4).map((f: string) => (
                                                <span
                                                    key={f}
                                    ...
                                    <div className="flex items-center justify-between mt-4 pt-3 border-t border-gray-100">
                                        <div className="flex items-baseline gap-1">
                                            ...
                                            <span className="text-sm text-gray-500">دج / ليلة</span>
                                        </div>
                                    </div>
                                </div>
                            </Link>
                    ...
                    <div className="text-center py-20">
                        ...
                        <p className="text-gray-500">جرب تغيير الفلاتر أو البحث في مدينة أخرى</p>
                    </div>
                )}
            </div>
        </div>
        ...
        <div className="min-h-screen bg-[#F9FAFB]">
            ...
            <div className="pt-24">
                ...
                <div className="bg-slate-900 py-20 relative overflow-hidden">
                    ...
                    <div className="section-padding relative">
                        <div className="max-w-4xl">
                            <div className="text-[10px] font-bold text-blue-400 uppercase tracking-[0.3em] mb-4">خدمات الإقامة</div>
                            <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">
                                الـفنادق والـمنتجعات
                            </h1>
                            <p className="text-slate-400 text-lg font-normal max-w-2xl leading-relaxed">
                                اختر من بين مجموعة متنوعة من الفنادق والمنتجعات السياحية في الجزائر، <br className="hidden md:block" /> مع تجربة حجز سلسة وآمنة تضمن لك أفضل الخيارات المتاحة.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div className="section-padding py-12">
                    <Suspense fallback={<div className="text-center py-20 text-gray-500">جاري تحميل العروض...</div>}>
                        <HotelsContent />
                    </Suspense>
                </div>
            </div>
